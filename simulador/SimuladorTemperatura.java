...
public class SimuladorTemperatura {
    ...
    // Palabras que el modelo podría elegir para completar:
    // "Mi aplicación de biblioteca se llama ..."
    static String[] opciones = {"BiblioTec", "LibroYa", "PrestaLibro", "LectoGo", "PaginaLibre", "NubeDeTinta"};

    // Puntaje que el modelo le da a cada opción (mayor = más probable)
    ...
    static double[] calcularProbabilidades(double t) {
        ...
        if (t <= 0) { // temperatura 0: siempre la opción con mayor puntaje
            prob[0] = 1.0;
            return prob;
        }
